...
type UrlShortenerE2ESuite struct {
	suite.Suite
...
func TestUrlShortenerSuite(t *testing.T) {
	suite.Run(t, new(UrlShortenerE2ESuite))
}

func (s *UrlShortenerE2ESuite) SetupTest() {
	s.T().Helper()
...
func (s *UrlShortenerE2ESuite) TearDownTest() {
	s.T().Helper()
...
func (s *UrlShortenerE2ESuite) setupRouter(storage *sqlite.Storage) *chi.Mux {
